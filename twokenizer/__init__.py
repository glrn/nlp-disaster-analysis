...
if __name__ == '__main__':
    # Library showcase
    print(tokenizeRawTweetText("BROOO HE JUST GOT ANNIHILATED https://t.co/UR7QkqG1wf"))
    print(tokenizeRawTweetText("@King_Naruto_ As long as I see Madara bleeding I'm good ??"))
    print(tokenizeRawTweetText("I think I just blew up @HopeInHearts notifications. Go check her out she's so encouraging to me ???? love her ??"))
    print(tokenizeRawTweetText("@LoneWolffur *slaps* no"))
    print(tokenizeRawTweetText("ICYMI - #Ashes 2015: Australia collapse at Trent Bridge - how Twitter reacted http://t.co/gl6eeJyJkY http://t.co/wqtDnP3w5a"))
    print(tokenizeRawTweetText("@Raishimi33 :) well I think that sounds like a fine plan where little derailment is possible so I applaud you :)"))
    print(tokenizeRawTweetText("OMG.This is sooo weird o.O"))
