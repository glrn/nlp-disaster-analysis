...
Finally, we extracted named entities to enrich our knowledge on the disaster (mostly location)... \todo{Omri - short description of method and achievements}. This part of our work is described in section \ref{mission3}.
	...
	\begin{center}
		\scalebox{0.8}{
			\begin{tabular}{c | c | c | c | c | c}
				  & $ \textbf{Geographical} $ & $
				  \textbf{Organization} $ & $ \textbf{Person} $ & $ \textbf{Geopolitical} $ & $ \textbf{Time} $ \\ \hline
