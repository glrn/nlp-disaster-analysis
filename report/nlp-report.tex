...
For both datasets we avoided from "re-tweeted" tweets (\tweet{RT}), to prevent repetitions of popular tweets.\\
...
The results show that both NER methods manage to identify the two recent large scale hurricanes that affected Houston (Hurricane Harvey) and Miami (Hurricane Harvey).
